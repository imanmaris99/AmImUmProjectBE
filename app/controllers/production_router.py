...
def get_brands_by_categories(
    ...
    """
    # Menampilkan List Brand dengan Pagination berdasarkan kategori #
    ...
    **Return:**
    ...
    """
    result = production_services.get_infinite_scrolling_by_category(
        db, 
