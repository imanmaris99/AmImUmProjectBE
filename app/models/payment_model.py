...
class PaymentModel(Base):
    ...
    payment_type = Column(String(50), nullable=True)  # e.g., credit_card, bank_transfer
    gross_amount = Column(DECIMAL(10, 2), nullable=False)
    transaction_status = Column(Enum(TransactionStatusEnum), nullable=True)
    fraud_status = Column(Enum(FraudStatusEnum), nullable=True)
